...
func setupRoutes(cfg *configuration.AppConfig, logger *logrus.Entry, dbSvc *dbservice.DBService,
	...
	if ui {
		...
		userRouter.HandleFunc("/apikey/list", bh.ListAPIKeysHandler)
		userRouter.HandleFunc("/apikey/add", bh.AddAPIKeyHandler)
		userRouter.HandleFunc("/apikey/{id}/edit", bh.EditAPIKeyHandler)
		userRouter.HandleFunc("/apikey/{id}/remove", bh.RemoveAPIKeyHandler)
